  ...
  const projects = [
    {
      ...
      image: "/images/1.png",
      location:
        "Plot No 16, Block 01, Bashir Elnefeidi Street, Khartoum, Sudan.",
      ...
      <section className="relative h-96 md:h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-3xl md:text-5xl font-bold text-center max-w-2xl px-4">
            Redefining Real Estate with Innovation and Integrity
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-3xl border border-gray-300 shadow-lg p-8 text-center">
            ...
            <p className="text-blue-400 leading-relaxed">
              ...
              quality and sustainability, contributing to the growth of modern
          ...
          <div className="bg-white rounded-3xl border border-gray-300 shadow-lg p-8 text-center">
            ...
            <p className="text-blue-400 leading-relaxed">
              ...
              project management and real estate services with a focus on
              quality, timeliness, and cost efficiency. Through standardized
              processes, advanced document systems, and digital innovation, we
              ensure clarity and informed decision-making. Committed to
              sustainability, we create eco-friendly projects while providing
              exceptional client experiences through tailored solutions and
              expert consulting.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <span className="text-amber-400 mr-2">✔</span>Proven Expertise
                in real estate, commercial, and tech project management.
              </li>
              <li>
                <span className="text-amber-400 mr-2">✔</span>Tailor-Made
                Solutions designed to meet each client&apos;s unique needs.
              </li>
              <li>
                <span className="text-amber-400 mr-2">✔</span>Commitment to
                Excellence with quality, cost control, and on-time delivery.
              </li>
              <li>
                <span className="text-amber-400 mr-2">✔</span>Transparency &
                Trust through clear reporting and project insights.
              </li>
              <li>
                <span className="text-amber-400 mr-2">✔</span>Innovative Vision
                aligned with evolving market trends.
              </li>
              <li>
                <span className="text-amber-400 mr-2">✔</span>Modern &
                Functional Designs combining elegance with practicality.
              </li>
              <li>
                <span className="text-amber-400 mr-2">✔</span>Comprehensive
                Services from planning to delivery and management.
              </li>
              <li>
                <span className="text-amber-400 mr-2">✔</span>Highest Standards
                in construction, finishing, and sustainability.
              </li>
            </ul>
          </div>
          <div>
